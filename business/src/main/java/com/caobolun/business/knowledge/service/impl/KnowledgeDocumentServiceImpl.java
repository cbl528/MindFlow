...
import com.caobolun.business.core.chunk.ChunkingOptions;
import com.caobolun.business.core.chunk.StructuredChunkingService;
import com.caobolun.business.core.chunk.VectorChunk;
import com.caobolun.business.core.ingest.embed.ChunkEmbeddingService;
import com.caobolun.business.core.parse.*;
    ...
    public void update(String docId, KnowledgeDocumentUpdateRequest requestParam) {
        ...
        if (StringUtils.hasText(requestParam.getProcessMode())) {
            ...
            if (ProcessMode.CHUNK == processMode) {
                ...
                updateWrapper.setSql("chunk_config = CAST({0} AS JSON)", chunkConfig);
