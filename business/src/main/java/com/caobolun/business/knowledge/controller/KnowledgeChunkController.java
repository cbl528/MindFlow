...
public class KnowledgeChunkController {
     ...
     * 分页查询 Chunk 列表
     */
    @GetMapping("/mindflow/knowledge-base/docs/{doc-id}/chunks")
     ...
     * 新增 Chunk
     */
    @PostMapping("/mindflow/knowledge-base/docs/{doc-id}/chunks")
     ...
     * 更新 Chunk 内容
     */
    @PutMapping("/mindflow/knowledge-base/docs/{doc-id}/chunks/{chunk-id}")
     ...
     * 删除 Chunk
     */
    @DeleteMapping("/mindflow/knowledge-base/docs/{doc-id}/chunks/{chunk-id}")
     ...
     * 启用或禁用单条 Chunk
     */
    @PatchMapping("/mindflow/knowledge-base/docs/{doc-id}/chunks/{chunk-id}/enable")
     ...
     * 批量启用或禁用 Chunk
     */
    @PatchMapping("/mindflow/knowledge-base/docs/{doc-id}/chunks/batch-enable")
