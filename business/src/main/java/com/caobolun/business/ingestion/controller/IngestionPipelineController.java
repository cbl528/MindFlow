...
public class IngestionPipelineController {
     ...
     * 创建数据摄入流水线
     */
    @PostMapping("/mindflow/ingestion/pipelines")
     ...
     * 更新数据摄入流水线
     */
    @PutMapping("/mindflow/ingestion/pipelines/{id}")
     ...
     * 获取单个数据摄入流水线详情
     */
    @GetMapping("/mindflow/ingestion/pipelines/{id}")
     ...
     * 分页查询数据摄入流水线
     */
    @GetMapping("/mindflow/ingestion/pipelines")
     ...
     * 删除数据摄入流水线
     */
    @DeleteMapping("/mindflow/ingestion/pipelines/{id}")
