  ...
  return (
    <div className="flex h-full flex-col items-center justify-center px-4 pb-16">
      ...
      <div className="grid w-full max-w-[720px] grid-cols-1 gap-3 sm:grid-cols-2">
        {(questions ?? Array.from({ length: 4 })).map((q, i) =>
          !questions ? (
            ...
            <button
              ...
              className="group animate-fade-in-up rounded-xl border border-border p-4 text-left transition-all hover:border-primary/40 hover:bg-accent/60"
